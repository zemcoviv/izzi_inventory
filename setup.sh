...
sudo -u postgres psql -c "CREATE USER \"psuser\" WITH PASSWORD 'password';"
sudo -u postgres psql -c "ALTER ROLE \"psuser\" SET client_encoding TO 'utf8';"
sudo -u postgres psql -c "ALTER ROLE \"psuser\" SET default_transaction_isolation TO 'read committed';"
sudo -u postgres psql -c "ALTER ROLE \"psuser\" SET timezone TO 'UTC';"
sudo -u postgres psql -c "GRANT ALL PRIVILEGES ON DATABASE network_inventory TO \"psuser\";"
